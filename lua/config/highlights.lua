...
vim.api.nvim_set_hl(0, "PmenuSel", {bg = colors.gray, fg = "NONE"})
vim.api.nvim_set_hl(0, "Pmenu", {fg = colors.fg, bg = "#EAEAEA"})
...
return vim.api.nvim_set_hl(0, "CmpItemKindTypeParameter", {fg = "#D8EEEB", bg = "#58B5A8"})